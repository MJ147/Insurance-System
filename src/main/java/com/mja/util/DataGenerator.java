...
public class DataGenerator {
    ...
    public void createData() {
        ...
        Client client5 = new Client("Alicja", "Penderewska", Arrays.asList(carInsurancePolicy6,homeInsurancePolicy5));
        ...
        InsuranceAgent insuranceAgent2 = new InsuranceAgent("Adam","Temerski",  Arrays.asList(client2,client3));
        client2.setInsuranceAgent(insuranceAgent2);
        client3.setInsuranceAgent(insuranceAgent2);
        ...
        client4.setInsuranceAgent(insuranceAgent3);
